...
const SEED_QUESTIONS_V1 = [
  ...
  // ---- JEE ----
  pp('JEE', 'JEE', 'Mechanics', 'A particle moves with constant speed in a circle. Its acceleration is:', ['Zero', 'Directed along the velocity', 'Directed towards the centre', 'Directed outwards'], 2, 'Exam level'),
  pp('JEE', 'JEE', 'Physical', 'The pH of a 0.01 M strong acid solution is:', ['1', '2', '10', '12'], 1, 'Exam level'),
  pp('JEE', 'JEE', 'Algebra', 'The number of real roots of x² + 4 = 0 is:', ['0', '1', '2', 'Infinite'], 0, 'Exam level'),
  ...
  // ---- LSAT ----
  pp('LSAT', 'LSAT', 'Assumptions', 'An argument’s necessary assumption is a claim that:', ['Restates the conclusion', 'Must be true for the conclusion to hold', 'Weakens the evidence', 'Introduces new evidence'], 1),
  pp('LSAT', 'LSAT', 'Main Point', 'The main point of a passage is best found by identifying:', ['The longest paragraph', 'The author’s overall claim', 'The first sentence', 'Any statistic quoted'], 1),
];
...
const SEED_QUESTIONS_V2 = [
  ...
  // ---- JEE ----
  pp('JEE', 'JEE', 'Electrostatics', 'The electric field inside a uniformly charged hollow conducting sphere is:', ['Maximum at the centre', 'Zero', 'Proportional to distance from centre', 'Inversely proportional to distance'], 1),
  pp('JEE', 'JEE', 'Coordination Compounds', 'The oxidation state of cobalt in [Co(NH₃)₆]Cl₃ is:', ['+1', '+2', '+3', '+6'], 2),
  pp('JEE', 'JEE', 'Calculus', 'The value of lim (x→0) (sin 3x)/x is:', ['0', '1', '3', '1/3'], 2, 'Easy'),
  pp('JEE', 'JEE', 'Waves', 'Two tuning forks of frequencies 256 Hz and 260 Hz are sounded together. The beat frequency is:', ['2 Hz', '4 Hz', '258 Hz', '516 Hz'], 1, 'Easy'),
  // ---- NEET (one combined subject) ----
...
export const SEED_PAPER_LINKS = [
  ...
  paper('JEE', 'JEE', 'JEE Main — official question paper archive (NTA)', 2025, 'https://jeemain.nta.nic.in/document-category/archive/'),
  paper('JEE', 'JEE', 'JEE Advanced — past papers (Archive section)', 2025, 'https://jeeadv.ac.in/'),
