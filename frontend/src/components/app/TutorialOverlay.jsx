...
const STEPS = [
  ...
  },
  {
    ...
    bullets: ['Flag questions, scan a photo of your working', 'Download as PDF, time it, upload your answers for marking', 'Missed questions come back as spaced reviews'],
  },
  {
    route: 'history',
    target: 'history',
  ...
  },
  {
    ...
    bullets: ['Ask for a revision plan', 'Re-run any diagnosis', 'Next best actions by weakest topic'],
  },
  {
    route: 'settings',
    target: 'settings',
    eyebrow: 'Step 10',
    title: 'Settings',
    body: 'Goals, difficulty, keyboard shortcuts, light or dark mode, and one switch that turns every AI assistant off. Redo this setup anytime.',
    bullets: ['Daily and weekly goals', 'AI on / off', 'Theme and shortcuts'],
  },
];
